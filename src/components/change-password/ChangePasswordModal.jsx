...
export const ChangePasswordModal = ({open, onConfirm, onCancel}) => {
  ...
  const handleShowCurrentPasswordClick = () =>
        ...
        <FormTextField
          ...
          helperText={
            errors.some(error => error.path === 'currentPassword')
              ? errors.find(error => error.path === 'currentPassword')
                  .errorMessage
              : ''
          }
        />
        ...
        <FormTextField
          ...
          helperText={
            errors.some(error => error.path === 'confirmNewPassword')
              ? errors.find(error => error.path === 'confirmNewPassword')
                  .errorMessage
              : ''
          }
        />
